...
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_OMI_Not_Running() trace_OMI_Not_Running_Impl(__FILE__, __LINE__)
#else
#define trace_OMI_Not_Running() trace_OMI_Not_Running_Impl(0, 0)
#endif
FILE_EVENT0(10007, trace_OMI_Not_Running_Impl, LOG_CRIT, PAL_T("OMI is not running"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_OMI_Already_Running() trace_OMI_Already_Running_Impl(__FILE__, __LINE__)
#else
#define trace_OMI_Already_Running() trace_OMI_Already_Running_Impl(0, 0)
#endif
FILE_EVENT0(10008, trace_OMI_Already_Running_Impl, LOG_CRIT, PAL_T("OMI is already running"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Stop_OMI_Failed() trace_Stop_OMI_Failed_Impl(__FILE__, __LINE__)
#else
#define trace_Stop_OMI_Failed() trace_Stop_OMI_Failed_Impl(0, 0)
#endif
FILE_EVENT0(10009, trace_Stop_OMI_Failed_Impl, LOG_CRIT, PAL_T("Failed to stop"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_ReloadConfig_OMI_Failed() trace_ReloadConfig_OMI_Failed_Impl(__FILE__, __LINE__)
#else
#define trace_ReloadConfig_OMI_Failed() trace_ReloadConfig_OMI_Failed_Impl(0, 0)
#endif
FILE_EVENT0(10010, trace_ReloadConfig_OMI_Failed_Impl, LOG_CRIT, PAL_T("Failed to reloadconfig"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_ReloadDispatcher_OMI_Failed() trace_ReloadDispatcher_OMI_Failed_Impl(__FILE__, __LINE__)
#else
#define trace_ReloadDispatcher_OMI_Failed() trace_ReloadDispatcher_OMI_Failed_Impl(0, 0)
#endif
FILE_EVENT0(10011, trace_ReloadDispatcher_OMI_Failed_Impl, LOG_CRIT, PAL_T("Failed to reloadDispatcher"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Need_Root_Access() trace_Need_Root_Access_Impl(__FILE__, __LINE__)
#else
#define trace_Need_Root_Access() trace_Need_Root_Access_Impl(0, 0)
#endif
FILE_EVENT0(10012, trace_Need_Root_Access_Impl, LOG_CRIT, PAL_T("Expected to run as root"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_Set_Sig_Handlers() trace_Failed_Set_Sig_Handlers_Impl(__FILE__, __LINE__)
#else
#define trace_Failed_Set_Sig_Handlers() trace_Failed_Set_Sig_Handlers_Impl(0, 0)
#endif
FILE_EVENT0(10013, trace_Failed_Set_Sig_Handlers_Impl, LOG_CRIT, PAL_T("Failed to set signal handlers"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_ChangeDir(a0) trace_Failed_ChangeDir_Impl(__FILE__, __LINE__, scs(a0))
#else
#define trace_Failed_ChangeDir(a0) trace_Failed_ChangeDir_Impl(0, 0, scs(a0))
#endif
FILE_EVENT1(10014, trace_Failed_ChangeDir_Impl, LOG_CRIT, PAL_T("Failed to change directory to: (%s)"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_Daemonize() trace_Failed_Daemonize_Impl(__FILE__, __LINE__)
#else
#define trace_Failed_Daemonize() trace_Failed_Daemonize_Impl(0, 0)
#endif
FILE_EVENT0(10015, trace_Failed_Daemonize_Impl, LOG_CRIT, PAL_T("Failed to daemonize server process"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_No_Service_Account() trace_No_Service_Account_Impl(__FILE__, __LINE__)
#else
#define trace_No_Service_Account() trace_No_Service_Account_Impl(0, 0)
#endif
FILE_EVENT0(10016, trace_No_Service_Account_Impl, LOG_CRIT, PAL_T("No service account provided"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Invalid_Service_Account(a0) trace_Invalid_Service_Account_Impl(__FILE__, __LINE__, scs(a0))
#else
#define trace_Invalid_Service_Account(a0) trace_Invalid_Service_Account_Impl(0, 0, scs(a0))
#endif
FILE_EVENT1(10017, trace_Invalid_Service_Account_Impl, LOG_CRIT, PAL_T("Invalid service account: (%s)"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Invalid_Service_Account_Root() trace_Invalid_Service_Account_Root_Impl(__FILE__, __LINE__)
#else
#define trace_Invalid_Service_Account_Root() trace_Invalid_Service_Account_Root_Impl(0, 0)
#endif
FILE_EVENT0(10018, trace_Invalid_Service_Account_Root_Impl, LOG_CRIT, PAL_T("Service account cannot be root"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_Selector_Init() trace_Failed_Selector_Init_Impl(__FILE__, __LINE__)
#else
#define trace_Failed_Selector_Init() trace_Failed_Selector_Init_Impl(0, 0)
#endif
FILE_EVENT0(10019, trace_Failed_Selector_Init_Impl, LOG_CRIT, PAL_T("Selector_Init failed"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_WSMAN_New_Listener_Failed(a0, a1) trace_WSMAN_New_Listener_Failed_Impl(__FILE__, __LINE__, a0, a1)
#else
#define trace_WSMAN_New_Listener_Failed(a0, a1) trace_WSMAN_New_Listener_Failed_Impl(0, 0, a0, a1)
#endif
FILE_EVENT2(10020, trace_WSMAN_New_Listener_Failed_Impl, LOG_CRIT, PAL_T("WSMAN_New_Listener() failed for port %u. Err = %d"), unsigned, int)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_MuxIn_Init() trace_Failed_MuxIn_Init_Impl(__FILE__, __LINE__)
#else
#define trace_Failed_MuxIn_Init() trace_Failed_MuxIn_Init_Impl(0, 0)
#endif
FILE_EVENT0(10021, trace_Failed_MuxIn_Init_Impl, LOG_CRIT, PAL_T("MuxIn_Init failed"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_New_Listener_Failed() trace_New_Listener_Failed_Impl(__FILE__, __LINE__)
#else
#define trace_New_Listener_Failed() trace_New_Listener_Failed_Impl(0, 0)
#endif
FILE_EVENT0(10022, trace_New_Listener_Failed_Impl, LOG_CRIT, PAL_T("Protocol_New_Listener() failed"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_New_Listener_Failed_Socket(a0) trace_New_Listener_Failed_Socket_Impl(__FILE__, __LINE__, scs(a0))
#else
#define trace_New_Listener_Failed_Socket(a0) trace_New_Listener_Failed_Socket_Impl(0, 0, scs(a0))
#endif
FILE_EVENT1(10023, trace_New_Listener_Failed_Socket_Impl, LOG_CRIT, PAL_T("Protocol_New_Listener() failed: %s"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_Socket_Directory_Create(a0) trace_Failed_Socket_Directory_Create_Impl(__FILE__, __LINE__, scs(a0))
#else
#define trace_Failed_Socket_Directory_Create(a0) trace_Failed_Socket_Directory_Create_Impl(0, 0, scs(a0))
#endif
FILE_EVENT1(10024, trace_Failed_Socket_Directory_Create_Impl, LOG_CRIT, PAL_T("Failed to create socket directory: %s"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_Socket_Directory_Chown(a0) trace_Failed_Socket_Directory_Chown_Impl(__FILE__, __LINE__, scs(a0))
#else
#define trace_Failed_Socket_Directory_Chown(a0) trace_Failed_Socket_Directory_Chown_Impl(0, 0, scs(a0))
#endif
FILE_EVENT1(10025, trace_Failed_Socket_Directory_Chown_Impl, LOG_CRIT, PAL_T("Failed to chown socket directory: %s"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_Generate_Socket_File_Name() trace_Failed_Generate_Socket_File_Name_Impl(__FILE__, __LINE__)
#else
#define trace_Failed_Generate_Socket_File_Name() trace_Failed_Generate_Socket_File_Name_Impl(0, 0)
#endif
FILE_EVENT0(10026, trace_Failed_Generate_Socket_File_Name_Impl, LOG_CRIT, PAL_T("Failed to generate socket file name"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_Generate_Secret_String() trace_Failed_Generate_Secret_String_Impl(__FILE__, __LINE__)
#else
#define trace_Failed_Generate_Secret_String() trace_Failed_Generate_Secret_String_Impl(0, 0)
#endif
FILE_EVENT0(10027, trace_Failed_Generate_Secret_String_Impl, LOG_CRIT, PAL_T("Failed to generate secret string"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_Socket_Pair() trace_Failed_Socket_Pair_Impl(__FILE__, __LINE__)
#else
#define trace_Failed_Socket_Pair() trace_Failed_Socket_Pair_Impl(0, 0)
#endif
FILE_EVENT0(10028, trace_Failed_Socket_Pair_Impl, LOG_CRIT, PAL_T("Failed to create socket pair"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_Fork() trace_Failed_Fork_Impl(__FILE__, __LINE__)
#else
#define trace_Failed_Fork() trace_Failed_Fork_Impl(0, 0)
#endif
FILE_EVENT0(10029, trace_Failed_Fork_Impl, LOG_CRIT, PAL_T("Failed to fork"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_Set_User_Engine() trace_Failed_Set_User_Engine_Impl(__FILE__, __LINE__)
#else
#define trace_Failed_Set_User_Engine() trace_Failed_Set_User_Engine_Impl(0, 0)
#endif
FILE_EVENT0(10030, trace_Failed_Set_User_Engine_Impl, LOG_CRIT, PAL_T("Failed to set uid/gid of engine"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Failed_Launch_Engine() trace_Failed_Launch_Engine_Impl(__FILE__, __LINE__)
#else
#define trace_Failed_Launch_Engine() trace_Failed_Launch_Engine_Impl(0, 0)
#endif
...
#endif
FILE_EVENT1(20106, trace_Timer_CannotStartTimer_AlreadyRunning_Impl, LOG_ERR, PAL_T("Timer_Start:Timer (%p) already running"), void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20107, trace_Timer_Initialization_Failed_Impl, LOG_ERR, PAL_T("Timer_Start:Timer cannot be initialized - Error (%x)"), PAL_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20108, trace_Timer_Selector_Missing_Impl, LOG_ERR, PAL_T("Timer_Start:Selector not specified or initialized (%p)"), void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(20109, trace_Timer_Cannot_AccessCurrentTime_Impl, LOG_ERR, PAL_T("Timer: Unable to access current time"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20110, trace_Timer_Cannot_AddHandlerToSelector_Impl, LOG_ERR, PAL_T("Timer_Start: Unable to add handler to selector (%p"), void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20111, trace_Timer_Double_Close_Impl, LOG_ERR, PAL_T("Timer_Close: Double close of timer (%p)"), void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20112, trace_Timer_Unexpected_Selector_Mask_Impl, LOG_ERR, PAL_T("Timer_Callback: Unexpected Selector mask %u"), PAL_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(20113, trace_Wsman_InvalidOperationTimeoutValue_Timestamp_Impl, LOG_ERR, PAL_T("_ValidateHeader: OperationTimeout must be xs:duration"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20114, trace_PreExecFailed_Impl, LOG_ERR, PAL_T("Failed to execute PREEXEC program: {%s}"), const char*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20115, trace_InvokeSubscribeWithInvalidTargetType_Impl, LOG_ERR, PAL_T("_Provider_InvokeSubscribe: Unsupported subscription type %x"), MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20116, trace_MI_SessionAlreadyConnected_Impl, LOG_ERR, PAL_T("MI Session already connected, operation %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20117, trace_MI_OutOfMemoryInOperation_Impl, LOG_ERR, PAL_T("Out of memory error, operation %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(20118, trace_MI_SocketConnectorFailed_Impl, LOG_ERR, PAL_T("MI Socket connector failed, operation %p, result %d"), void *, MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20119, trace_MI_FailedToStartRunThread_Impl, LOG_ERR, PAL_T("MI client failed to start run thread, operation %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(20120, trace_MI_SessionFailed_Impl, LOG_ERR, PAL_T("MI session init failed, session %p, result %d"), void *, MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20121, trace_MI_OutOfMemoryInSession_Impl, LOG_ERR, PAL_T("Out of memory error, session %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(20122, trace_MI_SessionConnectFailed_Impl, LOG_ERR, PAL_T("InteractionProtocolHandler_Session_Connect failed, session %p, result %d"), void *, MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(20124, trace_SocketConnectorFailed_Impl, LOG_ERR, PAL_T("(%c)Socket connect failed, locator %s"), char, const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20125, trace_LocalSocketFailed_Impl, LOG_ERR, PAL_T("Local socket failed on socket() call, sock %s"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20126, trace_LocalSocket_SetOnExecFailed_Impl, LOG_ERR, PAL_T("Socket SetOnExec failed, %s"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20127, trace_LocalSocket_SetBlockingFailed_Impl, LOG_ERR, PAL_T("Socket SetBlocking failed, %s"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(20128, trace_LocalSocket_ConnectFailed_Impl, LOG_ERR, PAL_T("Socket connect() failed, %s, error %d"), const char *, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(20129, trace_SSL_VerifyFailed_Impl, LOG_ERR, PAL_T("SSL error %d verifying with certificate: %s"), int, const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20130, trace_SSL_BadTrustDir_Impl, LOG_ERR, PAL_T("Bad SSL trusted certificates directory: %s"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(20131, trace_ProvReg_ProvRegEntry_NULLLibraryName_Impl, LOG_ERR, PAL_T("Library name is NULL for class: %S, in namespace: %S. Library Name should NOT be NULL"), const char *, const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20132, trace_ProvReg_SkipRegFile_Impl, LOG_ERR, PAL_T("Reg file %s is corrupted. It will be skipped by the server"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20133, trace_RegFile_MissingLibraryTag_Impl, LOG_ERR, PAL_T("LIBRARY tag is missing in reg file: %s"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_NtlmCredFileInvalid_OBSOLETE(a0) trace_NtlmCredFileInvalid_OBSOLETE_Impl(__FILE__, __LINE__, scs(a0))
#else
#define trace_NtlmCredFileInvalid_OBSOLETE(a0) trace_NtlmCredFileInvalid_OBSOLETE_Impl(0, 0, scs(a0))
#endif
FILE_EVENT1(20134, trace_NtlmCredFileInvalid_OBSOLETE_Impl, LOG_ERR, PAL_T("NTLM Credentials file does not exist or invalid permissions: %s"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(20148, trace_ProvReg_AccessDeniedRegFile_Impl, LOG_ERR, PAL_T("Reg file %s access denied. It will be skipped by the server"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(20149, trace_GetGroupList_Failure_Impl, LOG_ERR, PAL_T("User %s belongs to too many groups: %d"), const char *, int)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Http_Malloc_Error(a0) trace_Http_Malloc_Error_Impl(__FILE__, __LINE__, a0)
#else
#define trace_Http_Malloc_Error(a0) trace_Http_Malloc_Error_Impl(0, 0, a0)
#endif
FILE_EVENT1(20150, trace_Http_Malloc_Error_Impl, LOG_ERR, PAL_T("Http malloc exceeds reasonable limit: %d"), unsigned int)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Wsman_Malloc_Error(a0) trace_Wsman_Malloc_Error_Impl(__FILE__, __LINE__, a0)
#else
#define trace_Wsman_Malloc_Error(a0) trace_Wsman_Malloc_Error_Impl(0, 0, a0)
#endif
FILE_EVENT1(20151, trace_Wsman_Malloc_Error_Impl, LOG_ERR, PAL_T("Wsman malloc exceeds reasonable limit: %d"), unsigned int)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Username_Error(a0) trace_Username_Error_Impl(__FILE__, __LINE__, a0)
#else
#define trace_Username_Error(a0) trace_Username_Error_Impl(0, 0, a0)
#endif
FILE_EVENT1(20152, trace_Username_Error_Impl, LOG_ERR, PAL_T("Username exceeds reasonable limit: %d"), unsigned int)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Username_Error(a0) trace_Password_Error_Impl(__FILE__, __LINE__, a0)
#else
#define trace_Username_Error(a0) trace_Password_Error_Impl(0, 0, a0)
#endif
...
#endif
FILE_EVENT0(30215, trace_Stop_OMI_Impl, LOG_WARNING, PAL_T("Stop request received"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_ReloadConfig_OMI() trace_ReloadConfig_OMI_Impl(__FILE__, __LINE__)
#else
#define trace_ReloadConfig_OMI() trace_ReloadConfig_OMI_Impl(0, 0)
#endif
FILE_EVENT0(30216, trace_ReloadConfig_OMI_Impl, LOG_WARNING, PAL_T("ReloadConfig request received"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_ReloadDispatcher_OMI() trace_ReloadDispatcher_OMI_Impl(__FILE__, __LINE__)
#else
#define trace_ReloadDispatcher_OMI() trace_ReloadDispatcher_OMI_Impl(0, 0)
#endif
FILE_EVENT0(30217, trace_ReloadDispatcher_OMI_Impl, LOG_WARNING, PAL_T("ReloadDispatcher request received"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Stop_OMI_OK() trace_Stop_OMI_OK_Impl(__FILE__, __LINE__)
#else
#define trace_Stop_OMI_OK() trace_Stop_OMI_OK_Impl(0, 0)
#endif
FILE_EVENT0(30218, trace_Stop_OMI_OK_Impl, LOG_WARNING, PAL_T("OMI stopped"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_ReloadConfig_OMI_OK() trace_ReloadConfig_OMI_OK_Impl(__FILE__, __LINE__)
#else
#define trace_ReloadConfig_OMI_OK() trace_ReloadConfig_OMI_OK_Impl(0, 0)
#endif
FILE_EVENT0(30219, trace_ReloadConfig_OMI_OK_Impl, LOG_WARNING, PAL_T("OMI reloadConfig completed"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_ReloadDispatcher_OMI_OK() trace_ReloadDispatcher_OMI_OK_Impl(__FILE__, __LINE__)
#else
...
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_SigHUP_received_OBSOLETE(a0) trace_SigHUP_received_OBSOLETE_Impl(__FILE__, __LINE__, scs(a0))
#else
#define trace_SigHUP_received_OBSOLETE(a0) trace_SigHUP_received_OBSOLETE_Impl(0, 0, scs(a0))
#endif
FILE_EVENT1(40036, trace_SigHUP_received_OBSOLETE_Impl, LOG_INFO, PAL_T("SIGHUP received at: (%s)"), const char*)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_SigTERM_received_OBSOLETE(a0) trace_SigTERM_received_OBSOLETE_Impl(__FILE__, __LINE__, scs(a0))
#else
#define trace_SigTERM_received_OBSOLETE(a0) trace_SigTERM_received_OBSOLETE_Impl(0, 0, scs(a0))
#endif
FILE_EVENT1(40037, trace_SigTERM_received_OBSOLETE_Impl, LOG_INFO, PAL_T("SIGTERM received at: (%s)"), const char*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45000, trace_FunctionEntered_Impl, LOG_DEBUG, PAL_T("LOGTRACE: %s(%u)"), const char *, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45001, trace_BatchZdup_Failed_Impl, LOG_DEBUG, PAL_T("Batch_Zdup() failed: out of memory"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45002, trace_BatchAllocFailed_Impl, LOG_DEBUG, PAL_T("Batch allocation failed: out of memory"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45003, trace_BatchCreationFailed_Impl, LOG_DEBUG, PAL_T("Batch creation failed: out of memory"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45004, trace_HeapMemoryAllocFailed_Impl, LOG_DEBUG, PAL_T("Heap memory allocation failed: out of memory"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45005, trace_MessageFromBatch_Impl, LOG_DEBUG, PAL_T("MessageFromBatch:- msg tag is %d, index: %d"), MI_Uint32, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45006, trace_AgentElemPostingMessage_Impl, LOG_DEBUG, PAL_T("AgentElem: Posting message for interaction [%p]<-%p"), Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45007, trace_AgentElemAck_Impl, LOG_DEBUG, PAL_T("AgentElem: Ack on interaction [%p]<-%p"), Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45008, trace_AgentElemFoundKey_Impl, LOG_DEBUG, PAL_T("_AgentElem_FindRequest, Agent %p(%p), Found key: %x, Request: %p(%p)"), void *, Strand *, MI_Uint64, void *, Strand *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45009, trace_RequestItemPostingMessage_Impl, LOG_DEBUG, PAL_T("RequestItem: %p Posting message for interaction [%p]<-%p"), Strand *, Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45010, trace_RequestItemAck_Impl, LOG_DEBUG, PAL_T("RequestItem: Ack on interaction [%p]<-%p"), Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45011, trace_RequestItemCancel_Impl, LOG_DEBUG, PAL_T("_RequestItem_Cancel: on RequestItem (%p))"), Strand *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45012, trace_SendMessageToAgent_Impl, LOG_DEBUG, PAL_T("_SendMessageToAgent msg tag = %d"), int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45013, trace_PreExecRequest_Failed_Impl, LOG_DEBUG, PAL_T("_PreExecRequest_Failed preexec = %u"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45014, trace_AgentMgrHandleRequest_Impl, LOG_DEBUG, PAL_T("AgentMgr_HandleRequest %p (tag %d)"), void *, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45015, trace_ProvReg_BeginClasses_Failed_Impl, LOG_DEBUG, PAL_T("ProvReg_BeginClasses() failed: %u: %T"), unsigned short, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45016, trace_ProvReg_NextClass_Failed_Impl, LOG_DEBUG, PAL_T("ProvReg_NextClass() failed: %u: %T"), unsigned short, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45017, trace_ProvReg_EndClasses_Failed_Impl, LOG_DEBUG, PAL_T("ProvReg_EndClasses() failed: %u: %T"), unsigned short, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45018, trace_ProvReg_BeginAssocClasses_Failed_Impl, LOG_DEBUG, PAL_T("ProvReg_BeginAssocClasses() failed: %u: %T"), unsigned short, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45019, trace_ProvReg_NextAssocClass_Failed_Impl, LOG_DEBUG, PAL_T("ProvReg_NextAssocClass() failed: %u: %T"), unsigned short, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45020, trace_ProvReg_EndAssocClasses_Failed_Impl, LOG_DEBUG, PAL_T("ProvReg_EndAssocClasses() failed: %u: %T"), unsigned short, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45021, trace_FoundNoProvider_Impl, LOG_DEBUG, PAL_T("found no providers for class: %T"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45022, trace_DispDeleteInteraction_Impl, LOG_DEBUG, PAL_T("Disp: delete interaction [%p]"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45023, trace_DispatchEnumDispInteraction_Impl, LOG_DEBUG, PAL_T("_DispatchEnumerateInstancesReq() for class: %T (Thru Dispatcher Interaction)"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45024, trace_DispatchEnumDirectly_Impl, LOG_DEBUG, PAL_T("_DispatchEnumerateInstancesReq() for class: %T (Directly)"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45025, trace_DispatchAssoc_Impl, LOG_DEBUG, PAL_T("_DispatchAssocReq() for class: %T"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45026, trace_DispPostingMessage_Impl, LOG_DEBUG, PAL_T("Disp: Posting message for enum/assoc/ref interaction %p<-[%p]"), Interaction *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45027, trace_DispAckBaseInteraction_Impl, LOG_DEBUG, PAL_T("Disp: Ack on base interaction [%p]<-%p"), Strand *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45028, trace_NoProviderForClass_Impl, LOG_DEBUG, PAL_T("cannot find provider for class: %T/%T"), const TChar *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45029, trace_IndiMgrHandleSub_Impl, LOG_DEBUG, PAL_T("IndiMgr_HandleSubscribeReq() returns: %u"), MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45030, trace_ClassNameIsExpectedForInvoke_Impl, LOG_DEBUG, PAL_T("class name is expected for invoke"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT6(45031, trace_DispHandleInteractionRequest_Impl, LOG_DEBUG, PAL_T("Disp_HandleInteractionRequest: self (%p), interaction(%p), msg(%p:%d:%T:%x)"), void *, Interaction *, Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45034, trace_HttpSocketPosting_Impl, LOG_DEBUG, PAL_T("HttpSocket: Posting message for interaction [%p]<-%p"), Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45035, trace_HttpSocketAck_Impl, LOG_DEBUG, PAL_T("HttpSocket: Ack on interaction [%p]<-%p"), Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45036, trace_HttpSocketFinish_Impl, LOG_DEBUG, PAL_T("HttpSocket: %p _HttpSocket_Finish"), Strand *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45037, trace_HttpSocketAuxNewRequest_Impl, LOG_DEBUG, PAL_T("HttpSocket: %p _HttpSocket_Aux_NewRequest, Request: %p"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45038, trace_RequestItemParentPost_Impl, LOG_DEBUG, PAL_T("_RequestItem_ParentPost: %p, msg: %p"), void *, Message *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45039, trace_AgentItemCreated_Impl, LOG_DEBUG, PAL_T("AgentItem created: %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45040, trace_DiscoverClassesFoundTypeClass_Impl, LOG_DEBUG, PAL_T("_DiscoverClassAndChildrenClasses: Found %T class (%T)"), const TChar *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45041, trace_DiscoverClassesFailedToAdd_Impl, LOG_DEBUG, PAL_T("_DiscoverClassAndChildrenClasses: Failed to add ProvRegEntry for class (%T), error code (%d)"), const TChar *, MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45042, trace_DiscoverClassesNoRegInfo_Impl, LOG_DEBUG, PAL_T("_DiscoverClassAndChildrenClasses: No reginfo for %T class (%T) under namespace (%T)"), const TChar *, const TChar *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45043, trace_DiscoverClassesBeginFailed_Impl, LOG_DEBUG, PAL_T("_DiscoverClassAndChildrenClasses: ProvReg_BeginClasses failed: %u: %T; namespace (%T), classname (%T)"), MI_Result, const TChar *, const TChar *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45044, trace_DiscoverClassesNextFailed_Impl, LOG_DEBUG, PAL_T("_DiscoverClassAndChildrenClasses: ProvReg_NextClass failed: %u: %T; namespace (%T), classname (%T)"), MI_Result, const TChar *, const TChar *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45045, trace_DiscoverClassesBeginFailedProvRegEntry_Impl, LOG_DEBUG, PAL_T("_DiscoverClassAndChildrenClasses: Failed to add ProvRegEntry for class (%T), error (%d)."), const TChar *, MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45046, trace_DiscoverClassesEndFailed_Impl, LOG_DEBUG, PAL_T("_DiscoverClassAndChildrenClasses: ProvReg_EndClasses failed: %u: %T"), MI_Result, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45047, trace_DiscoverIndicationFoundClasses_Impl, LOG_DEBUG, PAL_T("_DiscoverIndicationClass: Found %d classes"), MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45048, trace_IndicationClassListCreated_Impl, LOG_DEBUG, PAL_T("IndicationClassList_NewByFilter: created clist(%p) succeed"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45049, trace_IndicationClassListDelete_Impl, LOG_DEBUG, PAL_T("IndicationClassList_Delete: self(%p)"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45050, trace_IndicationClassListDeleteCompleted_Impl, LOG_DEBUG, PAL_T("IndicationClassList_Delete: self(%p) complete"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45051, trace_QueueingSocket_Impl, LOG_DEBUG, PAL_T("Queueing on socket: %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45052, trace_FindSubRequest_FoundKey_Impl, LOG_DEBUG, PAL_T("__FindSubRequest: SubscribeElem %p(%p), Found key: %x, Request: %p(%p)"), void *, Strand *, MI_Uint64, void *, Strand *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45053, trace_ConnectionInAuxPostOther_Impl, LOG_DEBUG, PAL_T("_ConnectionIn_Aux_PostOther: %p, posting msg(%p:%d:%T:%x)"), Strand *, Message *, int, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45054, trace_ConnectionInClose_Impl, LOG_DEBUG, PAL_T("_ConnectionIn_Close: Closed on interaction [%p]<-%p"), Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45055, trace_ConnectionInFindRequest_CannotFind_Impl, LOG_DEBUG, PAL_T("_ConnectionIn_FindRequest, Agent %p(%p), Cannot find key: %x (may be new request)"), void *, Strand *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45056, trace_ConnectionInFindRequest_Found_Impl, LOG_DEBUG, PAL_T("_ConnectionIn_FindRequest, Agent %p(%p), Found key: %x, Request: %p(%p)"), void *, Strand *, MI_Uint64, void *, Strand *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT7(45057, trace_ConnectionIn_Post_Impl, LOG_DEBUG, PAL_T("_ConnectionIn_Post: %p Post msg(%p:%d:%T:%x) for interaction [%p]<-%p"), void *, Message *, MI_Uint32, const TChar *, MI_Uint64, Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45058, trace_ConnectionInPost_NewOp_Impl, LOG_DEBUG, PAL_T("_ConnectionIn_Post: New operation with operationId (%p), msg (%p:%T)"), void *, void *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT7(45059, trace_ConnectionIn_PostCancel_Impl, LOG_DEBUG, PAL_T("ConnectionIn: %p Post cancel msg(%p:%d:%T:%x) on interaction [%p]<-%p"), void *, Message *, MI_Uint32, const TChar *, MI_Uint64, Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45060, trace_ContextAuxPostLeft_Impl, LOG_DEBUG, PAL_T("_Context_Aux_PostLeft: %p, thisAckPending: %d"), Strand *, MI_Boolean)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45061, trace_ContextAuxPostLeftNotify_Impl, LOG_DEBUG, PAL_T("_Context_Aux_PostLeft_Notify: %p"), Strand *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45062, trace_ContextAuxPostLeftNotify_IoThread_Impl, LOG_DEBUG, PAL_T("_Context_Aux_PostLeft_Notify(IoThread): %p"), Strand *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45063, Context_PostMessageLeft_IoThread_Impl, LOG_DEBUG, PAL_T("Context_PostMessageLeft_IoThread: %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45064, trace_SelectorRun_Enter_Impl, LOG_DEBUG, PAL_T("SelectorRun(Enter): %p"), void *, MI_Uint64, MI_Boolean)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45065, trace_SelectorRun_Exit_Impl, LOG_DEBUG, PAL_T("SelectorRun(Exit): %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45066, trace_SelectorRun_Exit_Timeout_Impl, LOG_DEBUG, PAL_T("SelectorRun(Exit-Timeout): %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45067, trace_ContextCancel_Impl, LOG_DEBUG, PAL_T("_Context_Cancel: self (%p)"), Strand *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45068, trace_ContextClose_Impl, LOG_DEBUG, PAL_T("_Context_Close: Close on context %p, interaction %p->[%p]"), Strand *, Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45069, trace_ContextFinish_Impl, LOG_DEBUG, PAL_T("Context: %p, finish called"), Strand *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT6(45070, trace_ContextAck_Impl, LOG_DEBUG, PAL_T("Context: Ack on context %p, interaction %p->[%p], (Transport Closed: ByThis: %d, ByOther: %d), tryingToPostLeft: %x"), Strand *, Interaction *, Interaction *, MI_Boolean, MI_Boolean, ptrdiff_t)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45071, trace_ContextDestroy_Impl, LOG_DEBUG, PAL_T("Context: Destroy %p (strand: %p, interaction [%p])"), void *, Strand *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45072, trace_ContextNew_Impl, LOG_DEBUG, PAL_T("Context: New context %p with interaction: %p->[%p]"), void *, Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45073, trace_OperationOut_Ack_Impl, LOG_DEBUG, PAL_T("OperationOut: Ack on interaction [%p]<-%p"), Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45074, trace_OperationOut_Cancel_Impl, LOG_DEBUG, PAL_T("_OperationOut_Cancel: on OperationOut (%p))"), Strand *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45075, trace_OperationOut_Close_Impl, LOG_DEBUG, PAL_T("OperationOut: Close on interaction [%p]<-%p"), Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45076, trace_OperationIn_Ack_Impl, LOG_DEBUG, PAL_T("ConnectionIn: Ack on interaction [%p]<-%p"), Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45077, trace_DispEnumDone_Impl, LOG_DEBUG, PAL_T("Disp EnumDone (%p) total: %d Result: %d"), void *, int, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45078, trace_DispEntryDeleted_Impl, LOG_DEBUG, PAL_T("Disp EntryDeleted total: %d Done %d"), void *, int, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45079, trace_IndiMgr_SetLastError_Impl, LOG_DEBUG, PAL_T("_IndiMgr_SetLastError: self (%p) result(%d), error(%p)"), void *, MI_Result, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45080, trace_IndiMgr_New_Impl, LOG_DEBUG, PAL_T("IndiMgr_New: created IndicationManager (%p)"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45081, trace_IndiMgr_Delete_Impl, LOG_DEBUG, PAL_T("IndiMgr_Delete: self (%p)"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45082, trace_IndiMgr_Shutdown_Impl, LOG_DEBUG, PAL_T("IndiMgr_Shutdown: self (%p)"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45083, trace_IndiMgr_AddFilter_Impl, LOG_DEBUG, PAL_T("IndiMgr_AddFilter: self (%p), filter (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45084, trace_IndiMgr_RemoveFilter_Impl, LOG_DEBUG, PAL_T("IndiMgr_RemoveFilter: self (%p), filter (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45085, trace_IndiMgr_FilterNotRemoved_Impl, LOG_DEBUG, PAL_T("IndiMgr_RemoveFilter: Filter (%p) was not removed from IndicationManager (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45086, trace_IndiMgr_AddListener_Impl, LOG_DEBUG, PAL_T("IndiMgr_AddListener: self (%p), listener (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45087, trace_IndiMgr_RemoveListener_Impl, LOG_DEBUG, PAL_T("IndiMgr_RemoveListener: self (%p), listener (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45088, trace_IndiMgr_ListenerNotRemoved_Impl, LOG_DEBUG, PAL_T("IndiMgr_RemoveListener: Listener (%p) was not removed from IndicationManager (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45089, trace_IndiMgr_AddSubscription_Impl, LOG_DEBUG, PAL_T("IndiMgr_AddSubscription: self (%p), subscrip (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45090, trace_IndiMgr_RemoveSubscription_Impl, LOG_DEBUG, PAL_T("IndiMgr_RemoveSubscription: self (%p), subscrip (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45091, trace_IndiMgr_SubscriptionNotRemoved_Impl, LOG_DEBUG, PAL_T("IndiMgr_RemoveSubscription: Subscription (%p) was not removed from IndicationManager (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45092, trace_IndiMgr_ObjectExists_Impl, LOG_DEBUG, PAL_T("Object %T already exists."), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45093, trace_IndiMgr_CannotFindObject_Impl, LOG_DEBUG, PAL_T("_List_RemoveObjectByID: Cannot find object (%T)"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45094, trace_SubElem_PostComplete_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_Post: self (%p), msg(%p:%d:%T:%x) complete"), StrandMany *, Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45095, trace_SubElem_PostCancelSubscribe_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_Post: self (%p), msg(%p:%d:%T:%x), cancel all SubscribeEntries"), StrandMany *, Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45096, trace_SubElem_Post_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_Post: self (%p), unsupported msg(%p:%d:%T:%x)"), StrandMany *, Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45097, trace_SubElem_Ack_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_Ack: self (%p) interaction [%p]<-%p"), Strand *, Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45098, trace_SubElem_Cancel_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_Cancel: self (%p) interaction [%p]<-%p"), StrandMany *, Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45099, trace_SubElem_Finish_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_Finish: self (%p) interaction [%p]<-%p"), void *, Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45100, trace_SubElem_CheckSendFinalResult_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_CheckSendFinalResult: self(%p)"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45101, trace_SubElem_CheckSendComplete_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_CheckSendFinalResult: self (%p) status (%T); (%d) classes was handled; send final result message to protocol and closed self"), void *, const TChar *, MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT6(45102, trace_SubElem_NewEntry_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_NewEntry: self(%p) newEntry(%p) msg(%p:%d:%T:%x)"), StrandMany *, StrandEntry *, Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45103, trace_SubElem_NewEntry_UnexpectedMessage_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_NewEntry: Unexpected msg(%p:%x:%T:%x)"), Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45104, trace_SubItem_HandleRequest_Impl, LOG_DEBUG, PAL_T("_SubscribeItem_Added: self(%p) handle request namespace(%T), class(%T)"), void *, const TChar *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT8(45105, trace_SubElement_NewDone_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_NewEntry: DONE. self(%p); Classes: (%d)Scheduled; (%d)Sent; (%d)Handled (%d)Subscribed (%d)Failed (%d)Complete; Aggregate result (%d)"), StrandMany *, MI_Uint32, MI_Uint32, MI_Uint32, MI_Uint32, MI_Uint32, MI_Uint32, MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT6(45106, trace_SubElem_EntryPost_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_EntryPost: Posting message for interaction [%p]<-%p; msg(%p:%d:%T:%x)"), Interaction *, Interaction *, Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45107, trace_SubElem_PostSendSuccessResponse_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_EntryPost: self (%p) status (%T); send success response to protocol"), void *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45108, trace_SubElem_EntryPost_PassToLeft_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_EntryPost: Self (%p) received msg(%p:%d:%T:%x), pass to left"), void *, Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT8(45109, trace_SubElem_EntryPostDone_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_EntryPost: DONE. self(%p); Classes: (%d)Scheduled; (%d)Sent; (%d)Handled (%d)Subscribed (%d)Failed (%d)Complete; Aggregate result (%d)"), void *, MI_Uint32, MI_Uint32, MI_Uint32, MI_Uint32, MI_Uint32, MI_Uint32, MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45110, trace_SubElem_EntryClose_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_EntryClose: Done"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45111, trace_IndiMgr_HandleSubscribe_Impl, LOG_DEBUG, PAL_T("IndiMgr_HandleSubscribeReq: self (%p) interaction (%p) req (%p : OPID=%x)"), void *, Interaction *, void *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45112, trace_IndiMgr_HandleSubscribe_InvalidParameters_Impl, LOG_DEBUG, PAL_T("IndiMgr_HandleSubscribeReq: invalid parameter(s)"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45113, trace_IndiMgr_HandleSubscribe_FailedToSetNamespace_Impl, LOG_DEBUG, PAL_T("IndiMgr_HandleSubscribeReq: Failed to set namespace to filter (%p), req (%p)."), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45114, trace_IndiMgr_HandleSubscribe_FailedToAddSub_Impl, LOG_DEBUG, PAL_T("IndiMgr_HandleSubscribeReq: Failed to add subscription (%p), req (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45115, trace_IndiMgr_HandleSubscribe_NoClassFound_Impl, LOG_DEBUG, PAL_T("IndiMgr_HandleSubscribeReq: No class found, req(%p)"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45116, trace_IndiMgr_HandleSubscribe_FailedToCreateMessage_Impl, LOG_DEBUG, PAL_T("IndiMgr_HandleSubscribeReq: Failed to create subscribereq message for class %T, req (%p)"), const TChar *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45117, trace_IndiMgr_HandleSubscribe_BeginAddingEntry_Impl, LOG_DEBUG, PAL_T("IndiMgr_HandleSubscribeReq: begin to add entry (%p) msg (%p:%T), req(%p)"), void *, Message *, const TChar *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45118, trace_IndiMgr_HandleSubscribe_AddingEntryDone_Impl, LOG_DEBUG, PAL_T("IndiMgr_HandleSubscribeReq: end add entry (%p), req (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45119, trace_IndiMgr_HandleSubscribe_Done_Impl, LOG_DEBUG, PAL_T("IndiMgr_HandleSubscribeReq: self (%p) interaction (%p) req (%p : OPID=%x); done result (%d)"), void *, Interaction *, void *, MI_Uint64, MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45120, trace_Subscription_Finalize_Impl, LOG_DEBUG, PAL_T("Subscription_Finalize: self(%p)"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45121, trace_Subscription_OnAdd_Impl, LOG_DEBUG, PAL_T("Subscription_OnAdd: self(%p), container (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45122, trace_Subscription_OnAdd_Failed_Impl, LOG_DEBUG, PAL_T("Subscription_OnAdd: Failed to create class list"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45123, trace_Subscription_OnAdd_Success_Impl, LOG_DEBUG, PAL_T("Subscription_OnAdd: self(%p), container (%p) succeed"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45124, trace_Subscription_OnRemove_Impl, LOG_DEBUG, PAL_T("Subscription_OnRemove: self(%p), container (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45125, trace_Subscription_OnRemove_Result_Impl, LOG_DEBUG, PAL_T("Subscription_OnRemove: self(%p), container (%p), result (%d)"), void *, void *, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45126, trace_InteractionProtocolHandler_Client_Ack_Post_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Client_Ack_PostToInteraction %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45127, trace_InteractionProtocolHandler_Client_Ack_NoPost_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Client_Ack_NoPostToInteraction %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45128, trace_InteractionProtocolHandler_Operation_StrandPost_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Strand_Post: %p, msg(%p:%d:%T:%x)"), void *, Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45129, trace_MIResult_Impl, LOG_DEBUG, PAL_T("MI_Result = %T"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45130, trace_InteractionProtocolHandler_NoopRspTag_Impl, LOG_DEBUG, PAL_T("NoOpRspTag"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45131, trace_InteractionProtocolHandler_Operation_Strand_PostControl_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Strand_PostControl %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45132, trace_InteractionProtocolHandler_Session_ProtocolConnecting_Impl, LOG_DEBUG, PAL_T("==== InteractionProtocolHandler_Session_ConnectionEvents() PROTOCOLEVENT_CONNECT"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45133, trace_InteractionProtocolHandler_Session_ConnectFailed_Impl, LOG_DEBUG, PAL_T("==== InteractionProtocolHandler_Session_ConnectionEvents() PROTOCOLEVENT_CONNECT_FAILED"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45134, trace_InteractionProtocolHandler_Operation_Strand_Ack_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Strand_Ack %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45135, trace_InteractionProtocolHandler_Operation_Strand_Cancel_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Strand_Cancel %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45136, trace_InteractionProtocolHandler_Operation_Strand_Close_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Strand_Close %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45137, trace_InteractionProtocolHandler_Operation_Strand_Finish_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Strand_Finish %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45138, trace_InteractionProtocolHandler_Operation_Close_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Close %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45139, trace_InteractionProtocolHandler_Operation_Cancel_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Cancel %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45140, trace_InteractionProtocolHandler_Operation_CancelAfterFinal_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Cancel %p -- ignoring because we have already posted the final result"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45141, trace_InteractionProtocolHandler_Session_Close_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Session_Close %p (CompletionCallback %p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45142, trace_InteractionProtocolHandler_Protocol_RunThread_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Protocol_RunThread"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45143, trace_InteractionProtocolHandler_Protocol_RunThread_WithResult_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Protocol_RunThread finished with return %u"), MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45144, trace_SessionCloseCompletion_Release_CompletionCallback_Impl, LOG_DEBUG, PAL_T("SessionCloseCompletion_Release %p with CompletionCallback %p"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45145, trace_SessionCloseCompletion_Release_Count_Impl, LOG_DEBUG, PAL_T("SessionCloseCompletion_Release %p count is %d"), void *, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45146, trace_InteractionProtocolHandler_SessionConnect_Passed_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Session_Connect passed !"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45147, trace_ProtocolSocket_TimeoutTrigger_Impl, LOG_DEBUG, PAL_T("ProtocolSocket: triggering timeout on %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45150, trace_ProtocolSocket_CancelReceived_Impl, LOG_DEBUG, PAL_T("ProtocolSocket: Cancel received (closed other: %d) on interaction [%p]<-%p"), MI_Boolean, Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45160, trace_Provider_PostResult_Impl, LOG_DEBUG, PAL_T("post result from provider, %d"), MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45161, trace_EvaluateIndicationWithNull_Impl, LOG_DEBUG, PAL_T("EvaluateIndication with NULL input parameter"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45162, trace_PostIndicationWithUnsubscribedContext_Impl, LOG_DEBUG, PAL_T("PostIndication with unsubscribed context"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45163, trace_TerminateWithNullProvider_Impl, LOG_DEBUG, PAL_T("Terminate with NULL provider"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45164, trace_SubscrContext_ProviderPostingFailure_Impl, LOG_DEBUG, PAL_T("_SubscrContext_ProcessResult: Provider posted failure result (%d) while %T subscription (%p). Send final result"), MI_Result, const TChar *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45165, trace_PostIndicationWithNullInput_Impl, LOG_DEBUG, PAL_T("PostIndication with NULL input parameter"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45166, trace_PostIndicationOnDisabledAggContext_Impl, LOG_DEBUG, PAL_T("PostIndication on disabled aggregation context"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45167, trace_PostCalledWithInvalidContext_Impl, LOG_DEBUG, PAL_T("Post called with invalid context"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45168, trace_UnknownIndicationContextType_Impl, LOG_DEBUG, PAL_T("Unknown indication context type %d"), int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45169, trace_SubscribeContext_Cancel_Impl, LOG_DEBUG, PAL_T("_SubscribeContext_Cancel: self (%p);"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45170, trace_SubscribeContext_CancelDone_Impl, LOG_DEBUG, PAL_T("_SubscribeContext_Cancel: unsubscribe self (%p) done"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45171, trace_CreateFilterWithNullInput_Impl, LOG_DEBUG, PAL_T("Create filter with NULL input parameter"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45172, trace_EvaluateWQLWithNullInput_Impl, LOG_DEBUG, PAL_T("Evaluate WQL with NULL input parameter"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45173, trace_GetProviderByClassName_Impl, LOG_DEBUG, PAL_T("_GetProviderByClassName{%T}"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45174, trace_InitIndicationWithNullInput_Impl, LOG_DEBUG, PAL_T("InitIndication with NULL input parameter"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45175, trace_MultipleIndication_InitOfProviderForClass_Impl, LOG_DEBUG, PAL_T("Multiple indication initialization of provider for class %T"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45176, trace_ProviderInvokeSubscribe_Begin_Impl, LOG_DEBUG, PAL_T("_Provider_InvokeSubscribe: Start  Thread %x: provider (%p), msg (%p) with tag (%d), subcription (%p)"), unsigned int, void *, void *, MI_Uint32, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45177, trace_ProviderInvokeSubscribe_End_Impl, LOG_DEBUG, PAL_T("_Provider_InvokeSubscribe: Complete Thread %x: provider (%p), result (%d)"), unsigned int, void *, MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45178, trace_CannotUnloadNullProvider_Impl, LOG_DEBUG, PAL_T("Cannot unload NULL provider"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45179, trace_ProvMgr_PostingSchemaInWsmanToCallback_Impl, LOG_DEBUG, PAL_T("Posting schema in wsman form to callback from provmgr"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45180, trace_ProvMgr_ClassNotFound_Impl, LOG_DEBUG, PAL_T("Class not found %T"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45181, trace_ProvMgr_EnumerateInstancesOfClass_Impl, LOG_DEBUG, PAL_T("enumerate instances of %T"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45182, trace_ProvMgr_UnloadingProvider_Impl, LOG_DEBUG, PAL_T("Unloading provider %T"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45183, trace_ProvMgr_UnloadingLibrary_Impl, LOG_DEBUG, PAL_T("Unloading lib %s"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45184, trace_ProvMgr_NewRequest_UnsupportedMessage_Impl, LOG_DEBUG, PAL_T("ProvMgr_NewRequest: Unsupported message (%p:%T)"), Message *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45185, trace_CloseWithExistingSubscriptions_Impl, LOG_DEBUG, PAL_T("Close with existing subscriptions"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45186, trace_SubMgr_CancelAllSubscriptions_Impl, LOG_DEBUG, PAL_T("SubMgr_CancelAllSubscriptions: Thread %x: mgr (%p)"), unsigned int, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45187, trace_GetSubscription_NoSubscrPresent_Impl, LOG_DEBUG, PAL_T("No subscriptions present"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45188, trace_AddFilter_NullParameter_Impl, LOG_DEBUG, PAL_T("AddFilter with NULL input parameter"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45189, trace_SendResp_NullParameter_Impl, LOG_DEBUG, PAL_T("SendResp with NULL input parameter"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45190, trace_SubscriptionContext_NullParameter_Impl, LOG_DEBUG, PAL_T("SubscriptionContext init with NULL input"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45191, trace_SubscrContext_SendFinalResultMsg_Impl, LOG_DEBUG, PAL_T("SubscrContext_SendFinalResultMsg: subCtx (%p) result (%d)"), void *, MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45192, trace_SubscrContext_SendFinalResultMsg_Sent_Impl, LOG_DEBUG, PAL_T("SubscrContext_SendFinalResultMsg: subCtx (%p), result %d, msg(%p:%T) sent"), void *, MI_Result, void *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45193, trace_SubscrContext_SendSubscribeResponseMsg_Impl, LOG_DEBUG, PAL_T("SubscrContext_SendSubscribeResponseMsg: subCtx (%p)"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45194, trace_SubscrContext_SendSubscribeResponseMsg_Sent_Impl, LOG_DEBUG, PAL_T("SubscrContext_SendSubscribeResponseMsg: subCtx (%p), msg(%p:%T) sent"), void *, void *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45195, trace_SubscrContext_Unsubscribe_Impl, LOG_DEBUG, PAL_T("SubscrContext_Unsubscribe: subCtx (%p), provider (%p), subscription (%p) start"), void *, void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45196, trace_SubscrContext_AlreadyUnsubscribed_Impl, LOG_DEBUG, PAL_T("Subscription (%p) was already unsubscribed"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45197, trace_Subscription_StateInvalid_Impl, LOG_DEBUG, PAL_T("Subscription state %u is invalid for unsubscribe on class %T"), int, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45198, trace_SubscrContext_UnsubscribeDone_Impl, LOG_DEBUG, PAL_T("SubscrContext_Unsubscribe: subCtx (%p), provider (%p), subscription (%p); Complete"), void *, void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45199, trace_SubscrContext_UnsubprvdOrSendfinalmsgStart_Impl, LOG_DEBUG, PAL_T("SubscrContext_UnsubprvdOrSendfinalmsg: subCtx (%p), provider (%p), subscription (%p), invokeUnsubscribe(%d); start"), void *, void *, void *, MI_Boolean)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45200, trace_SubscrContext_UnsubprvdOrSendfinalmsgFinish_Impl, LOG_DEBUG, PAL_T("SubscrContext_UnsubprvdOrSendfinalmsg: subCtx (%p), provider (%p), subscription (%p), invokeUnsubscribe(%d); Complete"), void *, void *, void *, MI_Boolean)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45201, trace_RegFile_ParseIndication_ClassValueFailed_Impl, LOG_DEBUG, PAL_T("Parse indication class value failed."))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45202, trace_RegFile_AllocFailure_Impl, LOG_DEBUG, PAL_T("Allocate memory for RegClass failed."))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45203, trace_RegFile_IndicationClassCannotHaveRefClass_Impl, LOG_DEBUG, PAL_T("Indication class can not have reference class."))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45204, trace_RegFile_OutOfMemory_Name_Impl, LOG_DEBUG, PAL_T("Out of memory when duplicating name."))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45205, trace_RegFile_OutOfMemory_Hosting_Impl, LOG_DEBUG, PAL_T("Out of memory when duplicating hosting."))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45206, trace_Sock_SendingOnOwnThread_Impl, LOG_DEBUG, PAL_T("Sending msg(%p:%d:%T:%x) on own thread"), Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT7(45207, trace_Sock_Sending_Impl, LOG_DEBUG, PAL_T("Sending msg(%p:%d:%T:%x), outstandingInstances: %d, MAX: %d, numberOfItem: %d"), Message *, MI_Uint32, const TChar *, MI_Uint64, ptrdiff_t, int, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45208, trace_Sock_SentResult_Impl, LOG_DEBUG, PAL_T("Sending msg(%p:%d:%T:%x), result: %d"), Message *, MI_Uint32, const TChar *, MI_Uint64, MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45209, trace_Wsman_GotoFailed_Impl, LOG_DEBUG, PAL_T("goto failed: %s:%u"), const char *, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45210, trace_Wsman_ExpiredTimerForEnumerate_Impl, LOG_DEBUG, PAL_T("Expired timer for enumerate context %p (%u)"), void *, MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45211, trace_Wsman_EC_CheckCloseLeft_Impl, LOG_DEBUG, PAL_T("_EC_CheckCloseLeft: Left Closed: %d, activeConnection: %p"), int, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45212, trace_Wsman_EC_CheckCloseRight_Impl, LOG_DEBUG, PAL_T("_EC_CheckCloseRight: haveTimer: %d, Right Closed: %d"), int, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45213, trace_ProcessResultEnumerationContext_Impl, LOG_DEBUG, PAL_T("_ProcessResultEnumerationContext: selfEC (%p) result (%d)"), void *, MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45214, trace_ProcessSubscribeResponseEnumerationContext_Impl, LOG_DEBUG, PAL_T("_ProcessSubscribeResponseEnumerationContext: selfEC (%p)"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45215, trace_ProcessSubscribeResponseEnumerationContext_Success_Impl, LOG_DEBUG, PAL_T("_ProcessSubscribeResponseEnumerationContext: selfEC (%p) sent success subscribe response"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45216, trace_WsmanEnum_Impl, LOG_DEBUG, PAL_T("WsmanEnum: %p _ProcessInstanceEnumerationContext: compeleted: %d, totalResponses: %d, totalResponseSize: %d"), void *, MI_Boolean, MI_Uint32, MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT7(45217, trace_WsmanConnection_PostingMsg_Impl, LOG_DEBUG, PAL_T("WsmanConnection: Posting msg(%p:%d:%T:%x) on interaction %p<-[%p]<-%p"), Message *, MI_Uint32, const TChar *, MI_Uint64, Interaction *, Strand *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45218, trace_WsmanConnection_Ack_Impl, LOG_DEBUG, PAL_T("WsmanConnection: Ack on interaction [%p]<-%p"), Strand *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45219, trace_WsmanConnection_Close_Impl, LOG_DEBUG, PAL_T("WsmanConnection: Close on interaction [%p]<-%p outstandingRequest: %d, single_message: %p"), Strand *, Interaction *, MI_Boolean, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45220, trace_WsmanEnum_Finish_Impl, LOG_DEBUG, PAL_T("WsmanEnum: Finish: %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45221, trace_InteractionWsmanEnum_Left_SubscribeReAttached_Impl, LOG_DEBUG, PAL_T("_InteractionWsmanEnum_Left_SubscribeReAttached: %p, msg(%p:%d:%T:%x)"), void *, Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT7(45222, trace_WsmanEnum_PostingMsg_Impl, LOG_DEBUG, PAL_T("WsmanEnum: Posting msg(%p:%d:%T:%x) on interaction %p<-[%p]<-%p"), Message *, MI_Uint32, const TChar *, MI_Uint64, Interaction *, Strand *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45223, trace_WsmanEnum_Ack_Impl, LOG_DEBUG, PAL_T("WsmanEnum: Ack on interaction [%p]<-%p"), Strand *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45224, trace_Wsman_AddSubscribeResponse_Impl, LOG_DEBUG, PAL_T("_WSMAN_AddSubscribeResponse: selfEC (%p), contextID(%x)"), void *, MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45225, trace_Wsman_ParametersMissingInSubscribeRequest_Impl, LOG_DEBUG, PAL_T("wsman: mandatory parameters (className, namespace) are not provided for subscribe request"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45226, trace_ProcessUnsubscribeRequest_Impl, LOG_DEBUG, PAL_T("_ProcessUnsubscribeRequest: selfCD (%p)"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45227, trace_Wsman_UnableToFindContext_Impl, LOG_DEBUG, PAL_T("wsman: unable to find wsman context for unsubscribe request (contextID=%x)."), MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45228, trace_ProcessUnsubscribeRequest_Complete_Impl, LOG_DEBUG, PAL_T("_ProcessUnsubscribeRequest: selfCD (%p), msg (%p:%T) complete"), void *, Message *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45229, trace_Wsman_UnableToParseXMLSubscribe_Impl, LOG_DEBUG, PAL_T("wsman: unable to parse incoming xml/ subscribe request body"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45230, trace_Wsman_UnableToParseXMLUnsubscribe_Impl, LOG_DEBUG, PAL_T("wsman: unable to parse incoming xml/ unsubscribe request body"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45231, trace_WsmanReturn_Impl, LOG_DEBUG, PAL_T("RETURN{%s:%d}"), const char *, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45232, trace_BatchTcsDup_Failed_Impl, LOG_DEBUG, PAL_T("Batch_Tcsdup() failed: out of memory"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45233, trace_GetSingleProperty_Failed_Impl, LOG_DEBUG, PAL_T("_GetSingleProperty() failed: %T"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45234, trace_XsiTypeInvalidValue_Impl, LOG_DEBUG, PAL_T("invalid value of xsi:type: %T"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45235, trace_WsmanUnsubscribe_Impl, LOG_DEBUG, PAL_T("Unsubscribe e:identifier {%d}"), MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45236, trace_Wsman_UnexpectedCloseTagWithNamespace_Impl, LOG_DEBUG, PAL_T("wsman: unexpected close tag [%c:%T] in incoming xml"), TChar, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45237, trace_Wsman_UnknownMandatoryTagWithNamespace_Impl, LOG_DEBUG, PAL_T("wsman: unknown mandatory tag [%c:%T]; aborted"), TChar, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45238, trace_Wsman_FilterTagMissingDialectAttribute_Impl, LOG_DEBUG, PAL_T("wsman: Filter tag missing Dialect attribute"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45239, trace_Wsman_UnknownDialect_Impl, LOG_DEBUG, PAL_T("wsman: Unknown dialect (%T)"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45240, trace_Wsman_SubscribeDialect_Impl, LOG_DEBUG, PAL_T("wsman: Subscribe dialect (%T)"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45241, trace_Wsman_SubscribeFilter_Impl, LOG_DEBUG, PAL_T("wsman: Subscribe filter (%T)"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45242, trace_XmlSerializer_CurrentParent_Impl, LOG_DEBUG, PAL_T("current parent {%T}"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45243, trace_XmlSerializer_WriteBuffer_MiPropertyDecls_Impl, LOG_DEBUG, PAL_T("class = {%T} propagator = {%T} propertyName = %T"), const TChar *, const TChar *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT6(45244, trace_SubscribeEntry_PostInteraction_Impl, LOG_DEBUG, PAL_T("_SubscribeEntry_Post: Interaction [%p]<-%p, msg(%p:%d:%T:%x)"), Interaction *, Interaction *, Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45245, trace_SubscribeEntry_PostClosedSelf_Impl, LOG_DEBUG, PAL_T("_SubscribeEntry_Post: entry (%p) in status (%T). closed self."), void *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45246, trace_SubscribeEntry_PostEntry_Impl, LOG_DEBUG, PAL_T("_SubscribeEntry_Post: entry (%p) in status (%T)"), void *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45247, trace_SubscribeEntry_PostedMsg_Impl, LOG_DEBUG, PAL_T("_SubscribeEntry_Post: Posted msg(%p:%d:%T:%x) to parent"), Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45248, trace_SubscribeEntry_Ack_Impl, LOG_DEBUG, PAL_T("SubscribeEntry: Ack on interaction [%p]<-%p"), Strand *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45249, trace_SubscribeEntry_Cancel_Impl, LOG_DEBUG, PAL_T("_SubscribeEntry_Cancel: SubscribeEntry (%p); namespace (%T), class (%T)"), void *, const TChar *, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45250, trace_SubscribeEntry_Finish_Impl, LOG_DEBUG, PAL_T("_SubscribeEntry_Finish: Done"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45251, trace_Client_Post_Impl, LOG_DEBUG, PAL_T("_Client_Post: msg(%p:%d:%T:%x)"), Message *, MI_Uint32, const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Client_Ack() trace_Client_Ack_Impl(__FILE__, __LINE__)
#else
#define trace_Client_Ack() trace_Client_Ack_Impl(0, 0)
#endif
FILE_EVENT0(45252, trace_Client_Ack_Impl, LOG_DEBUG, PAL_T("_Client_Ack"))
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_Client_Close() trace_Client_Close_Impl(__FILE__, __LINE__)
#else
#define trace_Client_Close() trace_Client_Close_Impl(0, 0)
#endif
FILE_EVENT0(45253, trace_Client_Close_Impl, LOG_DEBUG, PAL_T("_Client_Close"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45254, trace_Client_Finish_Impl, LOG_DEBUG, PAL_T("_Client_Finish"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45255, trace_Client_PostMessage_Impl, LOG_DEBUG, PAL_T("_Client_Post: message tag: %d"), MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45256, trace_NullInputParameter_Impl, LOG_DEBUG, PAL_T("NULL input parameter"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45257, trace_NullInputParameterForClass_Impl, LOG_DEBUG, PAL_T("NULL input parameter for %T"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45258, trace_LifecycleContext_Cancel_Impl, LOG_DEBUG, PAL_T("_LifecycleContext_Cancel: self (%p);"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45259, trace_LifecycleContext_Cancel_Done_Impl, LOG_DEBUG, PAL_T("_LifecycleContext_Cancel: unsubscribe self (%p) done"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45260, trace_Provider_InvokeSubscribe_Impl, LOG_DEBUG, PAL_T("_Provider_InvokeSubscribe: subscription(%p) successfully subscribed. Send subscribe response"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45261, trace_SubscribeElem_Close_Impl, LOG_DEBUG, PAL_T("_SubscribeElem_Close: self_ (%p) interaction [%p]<-%p"), Strand *, Interaction *, Interaction *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45262, trace_Provider_TerminateIndication_Start_Impl, LOG_DEBUG, PAL_T("Provider_TerminateIndication: Thread %x: class (%T) of provider (%p) start"), unsigned int, const TChar *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45263, trace_Provider_TerminateIndication_Complete_Impl, LOG_DEBUG, PAL_T("Provider_TerminateIndication: Thread %x: class (%T) of provider (%p) complete"), unsigned int, const TChar *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45264, trace_DisablingLifeCycleIndicationsForClass_Impl, LOG_DEBUG, PAL_T("Disabling lifecycle indications for provider (%T)"), const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45265, trace_EnablingIndicationsForClass_Impl, LOG_DEBUG, PAL_T("Enabling indications for class (%T) of provider (%p)"), const TChar *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45266, trace_InitializedIndicationsForClass_Impl, LOG_DEBUG, PAL_T("Initialized indications for class (%T) of provider (%p)"), const TChar *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45267, trace_InteractionProtocolHandler_Operation_Cancel_OutOfMemory_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Cancel %p, out of memory while creating UnsubscribeReq"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45268, trace_InteractionProtocolHandler_Operation_Cancel_PostUnsubscribeReq_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Cancel %p, post UnsubscribeReq"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45269, trace_InteractionProtocolHandler_Operation_Strand_Post_Impl, LOG_DEBUG, PAL_T("InteractionProtocolHandler_Operation_Strand_Post: Post Indication to MIDLL. %p, indication instance (%p)"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45270, trace_Provider_InvokeDisable_Start_Impl, LOG_DEBUG, PAL_T("Provider_InvokeDisable: Thread %x: class (%T) of provider (%p) start"), unsigned int, const TChar *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45271, trace_Provider_InvokeDisable_Complete_Impl, LOG_DEBUG, PAL_T("Provider_InvokeDisable: Thread %x: class (%T) of provider (%p) complete"), unsigned int, const TChar *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45272, trace_Provider_InvokeDisable_AbandonSinceNewSubscriptionAdded_Impl, LOG_DEBUG, PAL_T("Provider_InvokeDisable: Thread %x: class (%T) of provider (%p) abandoned since new subscription was added"), unsigned int, const TChar *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45273, trace_LifecycleContext_Post_InvalidState_Impl, LOG_DEBUG, PAL_T("Post on lifecycle context in invalid state"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45274, trace_SubscrState_InvalidForUnsubscribe_Impl, LOG_DEBUG, PAL_T("Subscription state %u is invalid for unsubscribe on class %T"), int, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45279, trace_SubscrForEvents_Succeeded_Impl, LOG_DEBUG, PAL_T("Subscription succeeded for events of class (%T) with subscriptionID %llu"), const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45280, trace_SubscrForLifecycle_Succeeded_Impl, LOG_DEBUG, PAL_T("Subscription succeeded for lifecycle events of class (%T) and subscriptionID %llu"), const TChar *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45281, trace_RemovingSubscriptionForClass_Impl, LOG_DEBUG, PAL_T("Removing subscription (%llu) of class (%T)"), MI_Uint64, const TChar *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45282, trace_Wsman_ProcessReleaseRequest_Impl, LOG_DEBUG, PAL_T("_ProcessReleaseRequest: %x"), MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45283, trace_MIApplicationEnter_Impl, LOG_DEBUG, PAL_T("Enter %s with application (%p), protocol (%T), destination(%T), session (%p)."), const char *, void *, const MI_Char *, const MI_Char *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45284, trace_MILeavingSession_Impl, LOG_DEBUG, PAL_T("Leave %s with session (%p)."), const char *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45285, trace_MIThunkAfterShutdown_Impl, LOG_DEBUG, PAL_T("Trying to thunk a handle after shutdown called: %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45286, trace_MIShuttingDownThunkHandle_Impl, LOG_DEBUG, PAL_T("Shutting down thunk handle: %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45287, trace_MIReleaseThunkHandle_Impl, LOG_DEBUG, PAL_T("Release thunk handle: %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45288, trace_MIDecreaseRefcountWithoutReleaseThunkHandle_Impl, LOG_DEBUG, PAL_T("Decrease refcount without release thunk handle: %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45289, trace_MIIncreaseRefcountForThunkHandle_Impl, LOG_DEBUG, PAL_T("Increase refcount for thunk handle: %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45290, trace_MIGetThunkHandleFromGenericHandle_Impl, LOG_DEBUG, PAL_T("Get correct thunk handle %p from generic handle: %p"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45291, trace_MIThunkAfterThunkHandleRelease_Impl, LOG_DEBUG, PAL_T("Trying to thunk a handle after ThunkHandle_Release called: %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
#define trace_MISessionLog(a0) trace_MISessionLog_Impl(__FILE__, __LINE__, scs(a0))
#else
#define trace_MISessionLog(a0) trace_MISessionLog_Impl(0, 0, scs(a0))
#endif
FILE_EVENT1(45292, trace_MISessionLog_Impl, LOG_DEBUG, PAL_T("Session called: %s"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45293, trace_MISessionEnter_Impl, LOG_DEBUG, PAL_T("Enter %s with application (%p), protocol (%T), destination(%T), session (%p)."), const char *, void *, const MI_Char *, const MI_Char *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45294, trace_MISessionClose_Impl, LOG_DEBUG, PAL_T("Enter %s with session (%p), completionContext (%p), completionCallback (%p)."), const char *, void *, void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45295, trace_MIEnter_Impl, LOG_DEBUG, PAL_T("Enter %s - session (%p)"), const char *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45296, trace_MILeavingSessionWithOperation_Impl, LOG_DEBUG, PAL_T("Leave %s on session (%p) with for operation (%T)."), const char *, void *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45297, trace_MIClient_AppInit_Impl, LOG_DEBUG, PAL_T("MI_Client Application Initialize: application=%p, internal-application=%p"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45298, trace_MIClient_AppClose_Impl, LOG_DEBUG, PAL_T("MI_Client Application Close: application=%p, internal-application=%p"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45299, trace_MIClient_AppCloseCancelingAll_Impl, LOG_DEBUG, PAL_T("MI_Client Application Close: Cancelling all operations on application=%p, internal-application=%p, session=%p"), void *, void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45300, trace_MIClient_AppCloseWaitingOnSessions_Impl, LOG_DEBUG, PAL_T("MI_Client Application Close: Waiting for all sessions to shutdown on application=%p, internal-application=%p, number left=%llu"), void *, void *, ptrdiff_t)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45301, trace_MIClient_AppCloseWaitingOnHostedProviders_Impl, LOG_DEBUG, PAL_T("MI_Client Application Close: Waiting for all hosted providers to shutdown on application=%p, internal-application=%p, number left=%llu"), void *, void *, ptrdiff_t)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45302, trace_MIClient_AppCloseCompleted_Impl, LOG_DEBUG, PAL_T("MI_Client Application Close: completed application=%p, internal-application=%p"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45303, trace_MIClient_SessionCreate_Impl, LOG_DEBUG, PAL_T("MI_Client Session Create: application=%p, session=%p, internal-session=%p"), void *, void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45304, trace_MIClient_SessionCloseCompleted_Impl, LOG_DEBUG, PAL_T("MI_Client Session Close: Completed session=%p, internal-session=%p"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45305, trace_MIClient_SessionClose_Impl, LOG_DEBUG, PAL_T("MI_Client Session Close: session=%p, internal-session=%p"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45306, trace_MIClient_SessionClose_WaitingOnOperations_Impl, LOG_DEBUG, PAL_T("MI_Client Session Close: waiting for all operations to shutdown session=%p, internal-session=%p, number left=%llu"), void *, void *, ptrdiff_t)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45307, trace_MIClient_OperationInstancResultAsync_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Instance Result (async): session=%p, operation=%p, internal-operation=%p, resultCode=%u, moreResults=%T"), void *, void *, void *, MI_Result, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45308, trace_MIClient_OperationInstanceResult_WaitingForClient_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Instance Result (sync, waiting for client to get it): session=%p, operation=%p, internal-operation=%p, resultCode=%u, moreResults=%T"), void *, void *, void *, MI_Result, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45309, trace_MIClient_OperationClassResult_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Class Result: session=%p, operation=%p, internal-operation=%p, resultCode=%u, moreResults=%T"), void *, void *, void *, MI_Result, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45310, trace_MIClient_OperationIndicationResult_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Indication Result: session=%p, operation=%p, internal-operation=%p, resultCode=%u, moreResults=%T"), void *, void *, void *, MI_Result, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45311, trace_MIClient_OperationCloseCompleted_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Close: Complete session=%p, operation=%p, internal-operation=%p"), void *, void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45312, trace_MIClient_OperationClose_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Close: operation=%p, internal-operation=%p"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45313, trace_MIClient_OperationClose_WaitingForFinalResult_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Close: Waiting for the final result to be retrieved.  Client should retrieve the final result before calling MI_Operation_Close.  operation=%p, internal-operation=%p"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45314, trace_MIClient_OperationCancel_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Cancel: operation=%p, internal-operation=%p"), void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45315, trace_MIClient_GetInstance_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Get Instance: session=%p, operation=%p, internal-operation=%p, namespace=%T"), void *, void *, void *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT6(45316, trace_MIClient_Invoke_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Invoke: session=%p, operation=%p, internal-operation=%p, namespace=%T, classname=%T, methodname=%T"), void *, void *, void *, const MI_Char *, const MI_Char *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45317, trace_MIClient_EnumerateInstance_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Enumerate Instances: session=%p, operation=%p, internal-operation=%p, namespace=%T, classname=%T"), void *, void *, void *, const MI_Char *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT6(45318, trace_MIClient_QueryInstances_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Query Instances: session=%p, operation=%p, internal-operation=%p, namespace=%T, queryDialect=%T, queryExpression=%T"), void *, void *, void *, const MI_Char *, const MI_Char *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45319, trace_MIClient_OperationInstancResultSync_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Instance Result (sync): session=%p, operation=%p, internal-operation=%p, resultCode=%u, moreResults=%T"), void *, void *, void *, MI_Result, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45320, trace_MIClient_IndicationResultSync_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Indication Result (sync): session=%p, operation=%p, internal-operation=%p, resultCode=%u, moreResults=%T"), void *, void *, void *, MI_Result, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45321, trace_MIClient_ClassResultSync_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Class Result (sync): session=%p, operation=%p, internal-operation=%p, resultCode=%u, moreResults=%T"), void *, void *, void *, MI_Result, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT6(45323, trace_MIClient_ReferenceInstances_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Reference Instances: session=%p, operation=%p, internal-operation=%p, namespace=%T, resultClass=%T, role=%T"), void *, void *, void *, const MI_Char *, const MI_Char *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45324, trace_MIClient_ModifyInstance_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Modify Instance: session=%p, operation=%p, internal-operation=%p, namespace=%T"), void *, void *, void *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45325, trace_MIClient_CreateInstance_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Create Instance: session=%p, operation=%p, internal-operation=%p, namespace=%T"), void *, void *, void *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45326, trace_MIClient_DeleteInstance_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Delete Instance: session=%p, operation=%p, internal-operation=%p, namespace=%T"), void *, void *, void *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45327, trace_MIClient_GetClass_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Get Class: session=%p, operation=%p, internal-operation=%p, namespace=%T, className=%T"), void *, void *, void *, const MI_Char *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45328, trace_MIClient_EnumerateClasses_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Enumerate Classes: session=%p, operation=%p, internal-operation=%p, namespace=%s, className=%s"), void *, void *, void *, const MI_Char *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT6(45329, trace_MIClient_Subscribe_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Subscribe: session=%p, operation=%p, internal-operation=%p, namespace=%T, queryDialect=%T, queryExpression=%T"), void *, void *, void *, const MI_Char *, const MI_Char *, const MI_Char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45330, trace_MIClient_TestConnection_Impl, LOG_DEBUG, PAL_T("MI_Client Operation Test Connection: session=%p, operation=%p, internal-operation=%p"), void *, void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45331, trace_MIClient_OutOfMemory_Impl, LOG_DEBUG, PAL_T("MI_Client Out of memory!"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT6(45332, trace_SubMgr_DeleteSubscription_Start_Impl, LOG_DEBUG, PAL_T("SubMgr_DeleteSubscription: Start    Thread %x: mgr (%p) Subscription (%p); (%d) active subscriptions;  header (%p), tail (%p)"), unsigned int, void*, void *, unsigned int, void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT5(45333, trace_SubMgr_DeleteSubscription_Complete_Impl, LOG_DEBUG, PAL_T("SubMgr_DeleteSubscription: Complete Thread %x: mgr (%p); remains (%d) subscriptions; header (%p), tail (%p)"), unsigned int, void*, unsigned int, void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45334, trace_ScheduleRequest_UnsubscribeProvider_Impl, LOG_DEBUG, PAL_T("Schedule_UnsubscribeProvider: Thread %x: scheduled unsubscribe request for subscription (%p)"), unsigned int, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT4(45335, trace_ScheduleRequest_SubscribeProvider_Impl, LOG_DEBUG, PAL_T("Schedule_SubscribeRequest: Thread %x: scheduled subscribe request provider (%p), msg (%p), subContext (%p)"), unsigned int, void*, void *, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45336, trace_noniothread_proc_start_Impl, LOG_DEBUG, PAL_T("noniothread_proc_start: Thread %x:"), unsigned int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45337, trace_noniothread_proc_end_Impl, LOG_DEBUG, PAL_T("noniothread_proc_end: Thread %x:"), unsigned int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45338, trace_nioproc_FreeRequestItem_Impl, LOG_DEBUG, PAL_T("Free RequestItem : %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45339, trace_nioproc_CreateRequestItem_Impl, LOG_DEBUG, PAL_T("Create RequestItem : %p"), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45340, trace_SubMgrSubscription_ShouldCallUnsubscribe_Impl, LOG_DEBUG, PAL_T("SubMgrSubscription_ShouldCallUnsubscribe: Thread %x:; subscription (%p); should unsubscribe (%d)"), unsigned int, void*, MI_Boolean)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45341, trace_SubMgrSubscription_ShouldCallUnsubscribe_AlreadyUnsubscribed_Impl, LOG_DEBUG, PAL_T("SubMgrSubscription_ShouldCallUnsubscribe: Thread %x:; subscription (%p) was already unsubscribed"), unsigned int, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45342, trace_SubMgrSubscription_ShouldSendFinalMsg_Impl, LOG_DEBUG, PAL_T("SubMgrSubscription_ShouldSendFinalMsg: Thread %x:; subscription (%p); should send final message (%d)"), unsigned int, void*, MI_Boolean)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45343, trace_SubMgrSubscription_ShouldSendFinalMsg_AlreadySent_Impl, LOG_DEBUG, PAL_T("SubMgrSubscription_ShouldSendFinalMsg: Thread %x:; subscription (%p) already sent final message"), unsigned int, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45344, trace_SubMgr_GetSubscriptionByContext_NotFound_Impl, LOG_DEBUG, PAL_T("SubMgr_GetSubscriptionByContext: Thread %x:; mgr (%p) subscription (%p) not found"), unsigned int, void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45345, trace_SubscrContext_ProcessResult_Impl, LOG_DEBUG, PAL_T("_SubscrContext_ProcessResult: Thread %x: ctx (%p) subscription (%p)"), unsigned int, void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45346, trace_Timer_Started_OBSOLETE_Impl, LOG_DEBUG, PAL_T("Timer started with timeout value %I64u"), PAL_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45347, trace_Timer_Started_POSIX_Impl, LOG_DEBUG, PAL_T("Timer started with timeout value %llu"), PAL_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45348, trace_Timer_ManualTrigger_Impl, LOG_DEBUG, PAL_T("Timer_Fire: Manual trigger of timer (%p) on strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45349, trace_Timer_Close_Impl, LOG_DEBUG, PAL_T("Timer_Close: Closing timer (%p)"), void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45350, trace_Timer_CallbackMayRunLong_True_Impl, LOG_DEBUG, PAL_T("Timer_Callback: CallbackMayRunLong is TRUE"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45351, trace_Timer_CallbackMayRunLong_False_Impl, LOG_DEBUG, PAL_T("Timer_Callback: CallbackMayRunLong is FALSE"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45352, trace_Timer_Selector_Added_Impl, LOG_DEBUG, PAL_T("Timer_Callback: SELECTOR_ADD"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45353, trace_Unsubscribe_DisableProvider_Impl, LOG_DEBUG, PAL_T("DisableProvider: Thread %x: scheduled disable indications request for provider (%p)"), unsigned int, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45354, trace_Socket_Accept_Impl, LOG_DEBUG, PAL_T("Sock_Accept: sock (%d)"), int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45355, trace_Sock_Close_Impl, LOG_DEBUG, PAL_T("Sock_Close: sock (%d)"), int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45356, trace_ConnectionInPost_IgnoreUnsubscribeReq_Impl, LOG_DEBUG, PAL_T("_ConnectionIn_Post: binary protocol ignore UnsubscribeReq msg (%p), operationId (%x)"), void *, MI_Uint64)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT7(45357, trace_SubscribeEntry_PostFinalMsg_Impl, LOG_DEBUG, PAL_T("_SubscribeEntry_Post: entry (%p) in status (%T), received final msg(%p:%d:%T:%x), result (%d)"), void *, const TChar *, Message *, MI_Uint32, const TChar *, MI_Uint64, MI_Result)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45358, trace_SubMgrSubscription_Release_Finalized_Impl, LOG_DEBUG, PAL_T("SubMgrSubscription_Release: Thread %x: finalize subscription (%p), refcount is 0"), unsigned int, void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(45359, trace_WSManEnumerationContext_CD_Timeout_Notification_Ignored_Impl, LOG_DEBUG, PAL_T("_InteractionWsmanEnum_Left_ConnectionDataTimeout: Ignored because Post or Close already occurred on CD RM=%p, SM=%p, closed=%d"), void*, void*, MI_Boolean)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45360, trace_WSManEnumerationContext_CD_Timeout_notifier_Impl, LOG_DEBUG, PAL_T("_InteractionWsmanEnum_Left_ConnectionDataTimeout: CD notifier for EC %p"), void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45361, trace_ProcessSubscribeResponseEnumerationContext_TimedOutRequest_Impl, LOG_DEBUG, PAL_T("_ProcessSubscribeResponseEnumerationContext: selfEC (%p) Ignoring response to timed out request."), void *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45362, trace_EngineCredentialsVerified_Impl, LOG_DEBUG, PAL_T("Engine credentials verified (%p)"), void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45363, trace_ServerClosingSocket_Impl, LOG_DEBUG, PAL_T("Server closing socket (%p, %d)"), void*, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45364, trace_EngineClosingSocket_Impl, LOG_DEBUG, PAL_T("Engine closing socket (%p, %d)"), void*, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45365, trace_ServerEstablishingSocket_Impl, LOG_DEBUG, PAL_T("Server establishing socket with engine (%p, %d)"), void*, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45366, trace_EngineEstablishingSocket_Impl, LOG_DEBUG, PAL_T("Engine establishing socket with server (%p, %d)"), void*, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45367, trace_ServerInfoReceived_Impl, LOG_DEBUG, PAL_T("Server connection info received"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45368, trace_TrackerHashMapAdd_Impl, LOG_DEBUG, PAL_T("Tracker hash map added (%p, %d)"), void*, int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(45369, trace_TrackerHashMapRemove_Impl, LOG_DEBUG, PAL_T("Tracker hash map removeded (%d)"), int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(45374, trace_AskServerToAuthenticate_Impl, LOG_DEBUG, PAL_T("Asking Server to PAM authenticate"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45375, trace_AgentMgr_PreExec_RequestStrand_Post_Impl, LOG_DEBUG, PAL_T("AgentMgr_PreExec_RequestStrand_Post: preexecContext (%p), strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45376, trace_AgentMgr_PreExec_RequestStrand_PostControl_Impl, LOG_DEBUG, PAL_T("AgentMgr_PreExec_RequestStrand_PostControl: preexecContext (%p), strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45377, trace_AgentMgr_PreExec_RequestStrand_Ack_Impl, LOG_DEBUG, PAL_T("AgentMgr_PreExec_RequestStrand_Ack: preexecContext (%p), strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45378, trace_AgentMgr_PreExec_RequestStrand_Cancel_Impl, LOG_DEBUG, PAL_T("AgentMgr_PreExec_RequestStrand_Cancel: preexecContext (%p), strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45379, trace_AgentMgr_PreExec_RequestStrand_Close_Impl, LOG_DEBUG, PAL_T("AgentMgr_PreExec_RequestStrand_Close: preexecContext (%p), strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45380, trace_AgentMgr_PreExec_RequestStrand_Finish_Impl, LOG_DEBUG, PAL_T("AgentMgr_PreExec_RequestStrand_Finish: preexecContext (%p), strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45381, trace_AgentMgr_PreExec_ResponseStrand_Post_Impl, LOG_DEBUG, PAL_T("AgentMgr_PreExec_ResponseStrand_Post: preexecContext (%p), strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45382, trace_AgentMgr_PreExec_ResponseStrand_PostControl_Impl, LOG_DEBUG, PAL_T("AgentMgr_PreExec_ResponseStrand_PostControl: preexecContext (%p), strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45383, trace_AgentMgr_PreExec_ResponseStrand_Ack_Impl, LOG_DEBUG, PAL_T("AgentMgr_PreExec_ResponseStrand_Ack: preexecContext (%p), strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45384, trace_AgentMgr_PreExec_ResponseStrand_Cancel_Impl, LOG_DEBUG, PAL_T("AgentMgr_PreExec_ResponseStrand_Cancel: preexecContext (%p), strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(45385, trace_AgentMgr_PreExec_ResponseStrand_Close_Impl, LOG_DEBUG, PAL_T("AgentMgr_PreExec_ResponseStrand_Close: preexecContext (%p), strand (%p)"), void*, void*)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(50000, trace_HTTP_EncryptionFailed_Impl, LOG_DEBUG, PAL_T("HTTP: Encryption failed."))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT3(50001, trace_HTTP_GssStatus_Impl, LOG_DEBUG, PAL_T("HTTP: GSSstatus. gss:(%.*%s) mech:(%s) min_status:(%x)"), const int, const char *, const int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(50002, trace_HTTP_GssNtlmStatus_Impl, LOG_DEBUG, PAL_T("HTTP: gss ntlm status:(%s) username:(%s)"), const char *, const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(50003, trace_HTTP_GssError_Impl, LOG_DEBUG, PAL_T("HTTP: gss error:(%s)"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(50004, trace_HTTP_GetAddrInfoError_Impl, LOG_DEBUG, PAL_T("HTTP: get addr info error:(%s)"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(50005, trace_HTTP_LoadGssFailed_Impl, LOG_DEBUG, PAL_T("HTTP: Gss Library Load Failed:(%s)"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(50006, trace_HTTP_GssFunctionNotPresent_Impl, LOG_DEBUG, PAL_T("HTTP: Gss Function Not Present:(%s)"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(50007, trace_HTTP_AuthMallocFailed_Impl, LOG_DEBUG, PAL_T("HTTP: Authorization Malloc Failed:(%s)"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(50009, trace_HTTP_UserAuthFailed_Impl, LOG_DEBUG, PAL_T("HTTP: User Authorization failed. (%s)"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(50010, trace_HTTP_AuthComplete_Impl, LOG_DEBUG, PAL_T("HTTP: Authorization Complete."))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(50011, trace_HTTP_AuthContinue_Impl, LOG_DEBUG, PAL_T("HTTP: Authorization Continue."))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(50012, trace_HTTP_LoadingGssApi_Impl, LOG_DEBUG, PAL_T("HTTP: Loading gss api. (%s)"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(50013, trace_HTTP_SendNextAuthReply_Impl, LOG_DEBUG, PAL_T("HTTP: Send Next Auth Reply."))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(50016, trace_HTTP_CannotBuildAuthResponse_Impl, LOG_DEBUG, PAL_T("HTTP Auth: Cannot build response."))
#if defined(CONFIG_ENABLE_DEBUG)
